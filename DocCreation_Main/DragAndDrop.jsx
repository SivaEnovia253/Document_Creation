...
const DragAndDropComponent = () => {
  ...
  const handleSearch = (searchText) => {
    ...
    const handleSearchResults = (selectedObjects) => {
      // Check if there are any results and if they have a valid ID
      if (selectedObjects && selectedObjects.length > 0 && selectedObjects[0].id) {
        console.log("Selected object ID:", selectedObjects[0].id);
        handleDrop([
          {
